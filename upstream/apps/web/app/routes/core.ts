...
export const coreRoutes: RouteConfigEntry[] = [
  ...
  // Create Workspace
  layout("./(all)/create-workspace/layout.tsx", [
      ...
      layout("./(all)/[workspaceSlug]/(projects)/layout.tsx", [
        ...
        layout("./(all)/[workspaceSlug]/(projects)/active-cycles/layout.tsx", [
          route(
            ...
            "./(all)/[workspaceSlug]/(projects)/active-cycles/page.tsx",
          ),
        ]),
        ...
        layout("./(all)/[workspaceSlug]/(projects)/analytics/[tabId]/layout.tsx", [
          route(
            ":workspaceSlug/analytics/:tabId",
            "./(all)/[workspaceSlug]/(projects)/analytics/[tabId]/page.tsx",
          ),
        ]),
        ...
        layout("./(all)/[workspaceSlug]/(projects)/browse/[workItem]/layout.tsx", [
          route(
            ...
            "./(all)/[workspaceSlug]/(projects)/browse/[workItem]/page.tsx",
          ),
        ]),
        ...
        layout("./(all)/[workspaceSlug]/(projects)/notifications/layout.tsx", [
          route(
            ...
            "./(all)/[workspaceSlug]/(projects)/notifications/page.tsx",
          ),
        ]),
        ...
        layout("./(all)/[workspaceSlug]/(projects)/profile/[userId]/layout.tsx", [
          route(
            ...
            "./(all)/[workspaceSlug]/(projects)/profile/[userId]/page.tsx",
          ),
          route(
        ...
        layout("./(all)/[workspaceSlug]/(projects)/workspace-views/layout.tsx", [
          route(
            ...
            "./(all)/[workspaceSlug]/(projects)/workspace-views/page.tsx",
          ),
          route(
        ...
        layout("./(all)/[workspaceSlug]/(projects)/projects/(list)/layout.tsx", [
          route(
            ...
            "./(all)/[workspaceSlug]/(projects)/projects/(list)/page.tsx",
          ),
        ]),
        ...
        layout("./(all)/[workspaceSlug]/(projects)/projects/(detail)/[projectId]/layout.tsx", [
          // Project Issues List
          layout(
            "./(all)/[workspaceSlug]/(projects)/projects/(detail)/[projectId]/issues/(list)/layout.tsx",
            [
              route(
          ...
          // Cycles List
          layout(
            "./(all)/[workspaceSlug]/(projects)/projects/(detail)/[projectId]/cycles/(list)/layout.tsx",
            [
              route(
          ...
          // Modules List
          layout(
            "./(all)/[workspaceSlug]/(projects)/projects/(detail)/[projectId]/modules/(list)/layout.tsx",
            [
              route(
          ...
          // Views List
          layout(
            "./(all)/[workspaceSlug]/(projects)/projects/(detail)/[projectId]/views/(list)/layout.tsx",
            [
              route(
          ...
          // Pages List
          layout(
            "./(all)/[workspaceSlug]/(projects)/projects/(detail)/[projectId]/pages/(list)/layout.tsx",
            [
              route(
          ...
          // Intake list
          layout(
            "./(all)/[workspaceSlug]/(projects)/projects/(detail)/[projectId]/intake/layout.tsx",
            [
              route(
        ...
        layout(
          "./(all)/[workspaceSlug]/(projects)/projects/(detail)/[projectId]/archives/issues/(list)/layout.tsx",
          [
            route(
        ...
        layout(
          "./(all)/[workspaceSlug]/(projects)/projects/(detail)/[projectId]/archives/cycles/layout.tsx",
          [
            route(
        ...
        layout(
          "./(all)/[workspaceSlug]/(projects)/projects/(detail)/[projectId]/archives/modules/layout.tsx",
          [
            route(
      ...
      layout("./(all)/[workspaceSlug]/(settings)/layout.tsx", [
        ...
        layout("./(all)/[workspaceSlug]/(settings)/settings/(workspace)/layout.tsx", [
          route(
            ...
            "./(all)/[workspaceSlug]/(settings)/settings/(workspace)/page.tsx",
          ),
          route(
        ...
        layout("./(all)/[workspaceSlug]/(settings)/settings/projects/layout.tsx", [
          ...
          route(
            ":workspaceSlug/settings/projects",
            "./(all)/[workspaceSlug]/(settings)/settings/projects/page.tsx",
          ),
          layout("./(all)/[workspaceSlug]/(settings)/settings/projects/[projectId]/layout.tsx", [
            ...
            // Project Automations
            layout(
              "./(all)/[workspaceSlug]/(settings)/settings/projects/[projectId]/automations/layout.tsx",
              [
                route(
  ...
  route(
    ...
    "routes/redirects/core/workspace-account-settings.tsx",
  ),
