...
export const SubIssueDisplayFilters = observer(function SubIssueDisplayFilters(
  ...
  return (
    <>
      {layoutDisplayFiltersOptions?.display_filters &&
        layoutDisplayFiltersOptions?.display_properties.length > 0 && (
          <FiltersDropdown
            ...
            menuButton={
              ...
              >
                {isFilterApplied && (
                  <span className="absolute -top-1 -right-1 rounded-full bg-accent-primary p-1" />
                )}
