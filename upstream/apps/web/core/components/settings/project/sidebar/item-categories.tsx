...
export const ProjectSettingsSidebarItemCategories = observer(
  function ProjectSettingsSidebarItemCategories(props: Props) {
                ...
                {accessibleItems.map((item) => {
                  const isItemActive =
                    item.href === ""
                      ...
                      : new RegExp(
                          `^/${workspaceSlug}/settings/projects/${projectId}${item.href}/`,
                        ).test(pathname);
